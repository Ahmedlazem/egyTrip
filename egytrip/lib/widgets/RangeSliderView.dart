      ...
      child: Column(
        children: <Widget>[
              ...
              Row(
                children: <Widget>[
                  ...
                  Container(
                    width: 60,
                    child: Text(
                      "${widget.label} ${_values.start.round()}",
                      textAlign: TextAlign.center,
                    ),
                  ),
                  Expanded(
                    flex: widget.max.toInt() - _values.start.round(),
                    child: SizedBox(),
                  ),
                ],
              ),
              Row(
                children: <Widget>[
                  ...
                  Container(
                    width: 70,
                    child: Text(
                      "${widget.label} ${_values.end.round()}",
                      textAlign: TextAlign.center,
                    ),
                  ),
                  Expanded(
                    flex: widget.max.toInt() - _values.end.round(),
                    child: SizedBox(),
                  ),
                ],
              ),
          ...
          SliderTheme(
            ...
            child: RangeSlider(
              // labels: RangeLabels("camel", "star"),
              values: _values,
              min: widget.min.toDouble(),
              max: widget.max.toDouble(),
              activeColor: AppTheme.getTheme().primaryColor,
              inactiveColor: Colors.grey.withOpacity(0.4),
              // divisions: widget.division.toInt(),
